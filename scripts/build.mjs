...
export async function build() {
  ...
  const files = ['src/game/save-store.js', 'src/game/scenes.js', 'src/game/registry.js', ...setFiles, 'src/game/case.js', 'src/game/examine.js', 'src/game/session.js', 'src/game/audio.js', 'src/game/presentation.js', 'src/game/sprites.js', 'src/game/runtime.js'];
