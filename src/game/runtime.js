...
function ui(){
 ...
 case 'brief':
  el.caption.textContent='Rook: "Whoever has Bell\'s lantern knows where he went. If I lose it in this rain, I lose him." A stranger is lighting Bell\'s route with it, lamp by lamp, toward the closed North Station.';
 ...
 case 'result':
  ...
  rewindActions();break;
 case 'evidence':
  el.caption.textContent=state.choice==='person'?'The courier is Nell Marrow, Bell\'s apprentice. Nell: "I walk his route so it stays lit. He is alive in Pump Room 4. Knock three times; I will take you."':state.choice==='book'?'The page is fresh: "00:17 / I. BELL / PUMP ROOM 4 / JOB OPEN." The station is still being used. The courier\'s lantern is stencilled BELL / DEPOT LOFT.':'The rain has erased the entries. The cover still reads "PUMP ROOM 4." The lantern is stencilled BELL / DEPOT LOFT, and its carrier is in the back of a red car.';
