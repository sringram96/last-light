...
- The interface beside the scene shows: chapter title, objective, status/timer, a typed caption (one to three sentences), the choice buttons, the case file (route, persons of interest, evidence) and the records. Chapter cards and stingers are block-letter ASCII.
